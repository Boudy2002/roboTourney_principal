...
def win(level_count):
    if level_count < 2:
        screen.fill((255, 255, 255))
        PLAY_MOUSE_POS = pygame.mouse.get_pos()
        MENU_TEXT = get_font(70).render("YOU WIN!", True, "#000000")
        MENU_RECT = MENU_TEXT.get_rect(center=(400, 110))
        EASY_BUTTON = Button(image=pygame.image.load("Assets/Buttons/Play Rect.png"), pos=(400, 400),
                             text_input="NEXT LEVEL", font=get_font(50), base_color="#d7fcd4", hovering_color="White")
        screen.blit(MENU_TEXT, MENU_RECT)
        for button in [EASY_BUTTON]:
            button.changeColor(PLAY_MOUSE_POS)
            button.update(screen)
        ...
        MENU_TEXT = get_font(70).render("YOU WIN!", True, "#000000")
        MENU_RECT = MENU_TEXT.get_rect(center=(400, 110))
        EASY_BUTTON = Button(image=pygame.image.load("Assets/Buttons/Quit Rect.png"), pos=(400, 400),
